...
class Telecom_SMSNotifier_Model_Config
{
     ...
     * @return string
     */
    public function getTemplateIdForEvent($event, $storeId = null)
    {
        return (string)Mage::getStoreConfig("smsnotify/$event/sms_template_id", $storeId);
    }
    ...
    public function sanitizeNumber($number, $storeId = null)
    {
        ...
        $need_prefix = Mage::getStoreConfig("smsnotify/general/with_prefix", $storeId);
